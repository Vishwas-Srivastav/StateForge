...
Before making changes, read `.ai/AGENT_PROTOCOL.md`, then read `.ai/state.json`, `.ai/PROJECT.md`, `.ai/STATE.md`, `.ai/TASK.md`, `.ai/DECISIONS.md`, and the latest file in `.ai/handoffs/`.
